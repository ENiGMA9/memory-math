                    ...
                    <Row>
                        <Col xs={12} md={12}>
                            <Panel>
                                <Panel.Heading>
                                    <Panel.Title>
                                        <div onInput={this.changeTag} contentEditable='true'>Tag</div>
                                    </Panel.Title>
                                </Panel.Heading>
                                <Panel.Body>
                                    <div onInput={this.changeFormula} id="content"
                            ...
                            <InlineMath>{this.state.editableFormula}</InlineMath><br/><br/>
                            <Button bsStyle="success" onClick={this.handleFormulaSend}>Adauga</Button>
